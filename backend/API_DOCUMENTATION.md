# Company Comparables Finder API Documentation

## Overview
This API provides endpoints for analyzing companies and finding comparable public companies based on company name and website. It implements the core requirements from the README and includes extension features for financial metrics and interactive refinement.
